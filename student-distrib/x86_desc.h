...
//         uint8_t add_20_13 : 8;      // Address from 20:13
//         uint8_t RSVD : 1;           // RSVD
//         uint16_t address : 10;      // Address
...
//     struct {
//         page_dir_entry_4KB video;
//         page_dir_entry_4MB kernel;
//     } __attribute__((packed));
// } page_directories;

// // Array of structs that will have the 4KB and 4MB directory structs.
// extern page_directories base_dir[DIR_SIZE] __attribute__((aligned (ALIGNBYTES)));
// // Then, for the table, we will need 2^10 1024 tables with 1024 entries, pointing to pages.
// extern page_table_entry pte[TABLE_SIZE] __attribute__((aligned (ALIGNBYTES)));
